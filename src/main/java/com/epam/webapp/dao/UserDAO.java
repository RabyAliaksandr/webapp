...
public interface UserDAO {
  ...
  boolean sendOfferConsultations(int trainingId, Date date) throws ConnectionPoolException;

  Map<Training, Date> findConsultationsOffer(int mentorId) throws ConnectionPoolException;

  boolean sendAgreement(int trainingId, Date date, boolean mark) throws ConnectionPoolException;
}