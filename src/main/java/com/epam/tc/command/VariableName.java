 ...
 *
 * @author alex raby
 * @version 1.0 contains constants names that are used to assign or receive variables in a request
 */
public class VariableName {
  ...
  /**
   * The constant CARD_DONOR.
   */
  public static final String CARD_DONOR = "cardDonor";
  /**
   * The constant CART_RECIPIENT.
   */
