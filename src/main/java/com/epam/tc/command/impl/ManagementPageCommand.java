...
/**
 * The type Management page command.
 *
 * @author alex raby
 * @version 1.0 return management page and set value variable RequestVariableName.TYPE_OPERATION value takes from request {@link VariableName#TYPE_OPERATION}
 */
