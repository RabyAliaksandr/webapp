                ...
                <table class="table">
                    ...
                    <c:forEach var="task" items="${trainingService.getTasksListForTraining(trainingId)}">
                        <tr>
                            <td>${count}</td>
                            <td>
                                <a href="controller?command=task_page&trainingId=${trainingId}&taskId=${task.id}">${task.name}</a>
                            </td>
                        </tr>
                        <c:set var="count" value="${count + 1}"/>
                    </c:forEach>
