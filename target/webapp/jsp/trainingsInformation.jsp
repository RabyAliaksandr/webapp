    ...
    <section class="b">
        <div class="col-lg-6 col-md-6">
            <div class="container-fluid">
                ...
                <jsp:useBean id="topicService" class="com.epam.webapp.service.impl.TopicServiceImpl"/>
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <table class="table" id="tasks">
                        ...
                        <tbody>
                        <c:set var="count" value="1"/>
                        <jsp:useBean id="taskService" class="com.epam.webapp.service.impl.TaskServiceImpl"/>
